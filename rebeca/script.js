...
function mudarConteudoContato(){
    var novoConteudo = "<div class='center-block'><main><p><h4>Contato</h4><a href='https://www.linkedin.com/in/eng-rebecasampaio/'><img src='linkedin.png' style='box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.5); 'height='70px' width='70px'></a> <a href='https://www.instagram.com/r_sambrg/'><img src='insta.png' style='box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.5); ' height='70px' width='70px'></a> <a href='https://github.com/rsambrg' ><img src='git.png' style='box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.5);'height='70px' width='70px'></a><br><br><form enctype='multipart/form-data' class='formulario'><ul><li><label for='nome'> Nome: </label><input type='text' id='nome'><label for='email'> E-mail: </label><input type='text' id='email'></li><br><li><label>Interesse:</label><input type='radio' id='feedback' value='feedback'><label for='feedback'>Feedback</label><input type='radio' id='colaboracao' value='colaboracao'><label for='colaboracao'>Colaboração</label><br><input type='radio' id='outro-contato' value='outros'><label for='outro-contato'>Outro:<input type='text' size='8'></label><br></li><li><label for='mensagem'>Mensagem:</label><br><textarea rows='4' cols='25'></textarea><br><label for='foto'></li><li>Enviar uma foto:</label><input type='file' id='foto' name='foto'><br><br></li><li><label>Permissão para uso de dados:</label></br><input type='checkbox' id='usodedados' value='dados' name='permissao'><label for='usodedados' >Eu concordo que meus dados serão usados para responder à minha consulta.</label><br><br><input type='submit' value='Enviar'><input type='reset' value='Limpar'></li></ul></form></p></main></div>";
    document.getElementById("conteudo").innerHTML = novoConteudo;
}